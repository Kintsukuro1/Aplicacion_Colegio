  ...
  return (
    <PageTransition>
      <div className="p-6 space-y-6">
        <h1 className="text-3xl font-bold">Dashboard Animado</h1>
...
export function AnimatedCardGridExample() {
  ...
  return (
    <PageTransition>
      <div className="p-6">
        <h1 className="text-3xl font-bold mb-6">Mis Clases</h1>
          ...
          <CardEnhanced variant="hover_lift">
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                ...
                <div>
                  <p className="text-xs text-gray-500 uppercase tracking-wide">Biografía</p>
  ...
  return (
    <PageTransition>
      <div className="p-6 space-y-8">
        <div>
          <h1 className="text-3xl font-bold mb-2">Skeleton Variants</h1>
          <button
        ...
        <div>
          ...
          {showSkeleton ? <SkeletonAvatar size="h-20 w-20" /> : <div className="w-20 h-20 rounded-full bg-blue-400" />}
        </div>
      </div>
    </PageTransition>
  );
